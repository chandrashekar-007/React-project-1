...
function App() {
  ...
  return (
    <>
      <Navbar title="Reactjs Tutorials" service="Our services" mode={mode} toggleSwitch1={toggleSwitch1} toggleSwitch={toggleSwitch} toggleSwitch2={toggleSwitch2} toggleSwitch3={toggleSwitch3} toggleSwitch4={toggleSwitch4}/>
      <Alert alert={alert}/>
      <Conversion showAlert={showAlert} mode={mode} />
      {/* <About/> */}
